...
<style>
        ...
        body {
            ...
            padding: 0;
            height: 100vh;
            background-image: url('index.jpg'); /* đường dẫn tới ảnh */
...
.create-form{
    ...
    margin: 50px auto;  /* trên/dưới 50px, trái/phải tự động căn giữa */
...
<style>
.create-form-wrapper {
    width: 400px;                 /* độ rộng bao gồm cả h3 và form */
    margin: 50px auto;            /* căn giữa trang */
    text-align: left;             /* chữ căn trái */
}

.create-form-wrapper h3 {
    margin-bottom: 15px;          /* khoảng cách giữa h3 và form */
